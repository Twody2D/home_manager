...
class RefreshToken(Base):
    """An issued refresh token, tracked server-side to support rotation and revocation."""
...
class MemberInvite(Base):
    """A single-use, expiring link an owner generates to bring a partner into
    the household — the partner picks their own email/password when they
    redeem it, so the owner never has to know or choose either.
    """
